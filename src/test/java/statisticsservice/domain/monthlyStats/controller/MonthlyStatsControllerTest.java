...
class MonthlyStatsControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    @DisplayName("월간 인기 게시판 조회_성공")
    void monthlyTopBoardDetails_Success() throws Exception {
        ...
        actions
                ...
                .andDo(document("monthlyTopBoardDetails",
                        ...
                        responseFields(
                                fieldWithPath("id").description("월간 상위 게시판 ID"),
